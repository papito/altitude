...
| Parameter | Values |
|---|---|
| `groupBy` | `dateTaken` (capture day, the camera's calendar date). Anything else, including empty, is a 400. Grouping by import day was removed: an import lands a whole archive on one or two days. |

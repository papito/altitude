...
object UserToken:
  given JsonCodec.ReadWriter[UserToken] = JsonCodec
...
case class UserToken(userId: String, token: String, expiresAt: LocalDateTime) extends BaseModel with NoId with NoDates:

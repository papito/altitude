...
object Const:
  ...
  // Dialog titles: the folder dialogs and the album rename/delete dialogs show inline in the entity's
  // menu, the others in the modal host, whose sizing is owned by CSS (`--modal-content-width` in core.css).
  object UI:
    ...
    val ADD_ALBUM_DIALOG_TITLE = "Add an album"

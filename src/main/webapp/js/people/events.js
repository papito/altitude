...
import {showSuccessSnackBar} from "/js/common/snackbar.js"
...
document.body.addEventListener(Const.events.confirmPersonMerge, (event) => {
    ...
    console.debug("Person " + mergeSourceId + " dragon dropped into " + mergeDestId)
    ...
    htmx.ajax(
        "GET",
        `/htmx/people/r/${context.repoId}/modals/merge`, {
            "swap": "innerHTML",
            "target": "#modalContent",
            "values": {...event.detail},
        })

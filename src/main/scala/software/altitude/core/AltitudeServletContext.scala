...
import software.altitude.core.controllers.htmx.{AlbumActionController, AssetActionController, FolderActionController, NavigationController, PeopleActionController, SearchResultsController, SetupController, ViewSettingsActionController}
